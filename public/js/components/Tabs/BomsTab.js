              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-2xl border cursor-pointer transition active:scale-98 ${
                    isSelected
                      ? 'bg-gradient-to-r from-indigo-500/15 to-purple-500/15 border-indigo-500/50 shadow-md ring-1 ring-indigo-500/30'
                      : 'liquid-glass hover:bg-white/90 dark:hover:bg-slate-800/90 shadow-xs'
                  }`}
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-mono font-bold text-xs text-indigo-700 dark:text-indigo-300 bg-indigo-500/10 px-2 py-0.5 rounded-lg border border-indigo-500/20">
                      v{bom.version}
                    </span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200/60 dark:border-slate-800">
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-mono font-bold text-xs bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-2.5 py-1 rounded-lg shadow-xs">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button
                    ...
                    className="px-3.5 py-2 bg-white dark:bg-slate-800 hover:bg-slate-50 text-slate-800 dark:text-slate-200 rounded-xl text-xs font-bold flex items-center gap-1.5 border border-slate-200 dark:border-slate-700 cursor-pointer"
                  >
                  ...
                  {selectedBom.status === 'SUBMITTED' && (
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white font-bold text-xs rounded-xl shadow-md shadow-indigo-500/25 flex items-center gap-1.5 transition active:scale-95 cursor-pointer"
                    >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-4 gap-1.5 text-center font-mono pt-1">
                        ...
                        <div className="bg-purple-500/10 p-1.5 rounded-xl border border-purple-500/20">
                          <div className="text-[9px] uppercase font-bold text-purple-400">Đã Khóa</div>
                    ...
                    {(selectedBom.items || []).map(item => {
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-white/60 dark:hover:bg-slate-800/40 transition">
                          ...
                          <td className="py-3 px-2 text-right font-mono text-purple-600 dark:text-purple-400 font-bold">
                            {resv}
                          </td>
