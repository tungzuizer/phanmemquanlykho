 ...
 * Affected API: window.WMS_COMPONENTS.KpiTab
 * Data schemas: { orders, goodsDispatchNotes, returnVouchers, stockBalances, stockTransactions }
        ...
        <div className="liquid-glass rounded-2xl border border-white/40 dark:border-white/10 p-5 shadow-xs flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-bold text-cyan-600 dark:text-cyan-400 bg-cyan-500/10 px-2.5 py-0.5 rounded-full border border-cyan-500/20">
                Mục tiêu ≥ 99%
              </span>
            </div>
            <div className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white font-mono mt-3">
          ...
          <div className="space-y-2 pt-3 border-t border-slate-200/60 dark:border-slate-800">
            ...
            <div className="flex justify-between text-[11px] text-slate-400">
              ...
              <span className="font-bold text-cyan-600 dark:text-cyan-400">Xuất sắc</span>
            </div>
          </div>
        </div>
